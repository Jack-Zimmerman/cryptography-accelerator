...
VL_ATTR_COLD void Vhashcore_tb_doublesha___eval_static__TOP__hashcore_tb__DOT__DUT__DOT__genblk1__BRA__0__KET____DOT__HASHCORE(Vhashcore_tb_doublesha* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhashcore_tb_doublesha___eval_static__TOP__hashcore_tb__DOT__DUT__DOT__genblk1__BRA__0__KET____DOT__HASHCORE\n"); );
    // Body
...
VL_ATTR_COLD void Vhashcore_tb_doublesha___stl_sequent__TOP__hashcore_tb__DOT__DUT__DOT__genblk1__BRA__0__KET____DOT__HASHCORE__0(Vhashcore_tb_doublesha* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhashcore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhashcore_tb_doublesha___stl_sequent__TOP__hashcore_tb__DOT__DUT__DOT__genblk1__BRA__0__KET____DOT__HASHCORE__0\n"); );
    // Body
...
VL_ATTR_COLD void Vhashcore_tb_doublesha___ctor_var_reset(Vhashcore_tb_doublesha* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhashcore_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vhashcore_tb_doublesha___ctor_var_reset\n"); );
    // Body
