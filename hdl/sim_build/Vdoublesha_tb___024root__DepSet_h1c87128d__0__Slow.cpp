...
VL_ATTR_COLD void Vdoublesha_tb___024root___eval_initial__TOP(Vdoublesha_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdoublesha_tb___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<5>/*159:0*/ __Vtemp_1;
    // Body
    __Vtemp_1[0U] = 0x2e766364U;
    __Vtemp_1[1U] = 0x74657374U;
    __Vtemp_1[2U] = 0x726d732fU;
    __Vtemp_1[3U] = 0x7665666fU;
...
VL_ATTR_COLD void Vdoublesha_tb___024root___eval_triggers__stl(Vdoublesha_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdoublesha_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdoublesha_tb___024root___eval_triggers__stl\n"); );
    // Body
