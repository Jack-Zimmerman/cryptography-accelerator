...
#ifndef VERILATED_VHASHCORE_TB_DOUBLESHA_H_
#define VERILATED_VHASHCORE_TB_DOUBLESHA_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhashcore_tb_doublesha final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vhashcore_tb_doublesha(Vhashcore_tb__Syms* symsp, const char* v__name);
    ~Vhashcore_tb_doublesha();
    VL_UNCOPYABLE(Vhashcore_tb_doublesha);
